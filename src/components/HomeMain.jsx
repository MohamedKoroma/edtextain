        ...
        <div className="container w-full flex max-lg:flex-col max-2xl:items-start items-center">
          ...
          <div className="w-1/2 max-lg:w-full">
            <div className="absolute w-fit max-lg:w-7/12 max-sm:max-w-[500px] max-sm:w-full max-lg:mx-auto max-lg:relative bottom-0">
              ...
              <div className="absolute right-[40%] left-[8%] max-xl:left-0 top-[5%] w-16 max-xl:w-12">
                <img src={hand_price} alt="handpricelogo" />
              </div>
              {/* -left-[15%] max-sm:left-0*/}
              <img
                src={join_our_Team}
                className="absolute bottom-5 -left-[15%] max-sm:left-0  w-2/5 max-sm:w-[45%] "
                alt=""
              />
              {/* bottom-14 right-[10rem] max-sm:right-0 max-sm:bottom-5 w-1/3 */}
              <img
                src={total_donations}
                className="absolute  bottom-14 right-[10rem] max-sm:right-0 max-sm:bottom-5 w-1/3 max-xl:w-2/6 max-lg:w-2/5 max-lg:-right-0 max-sm:w-[45%]"
                alt=""
              />
            </div>
          </div>
